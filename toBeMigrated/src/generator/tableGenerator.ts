...
function generateTable(data: any, schema: any, options: any = {}) {
...
function generateHeader(schema: any) {
	...
	// 最后转化 matrix 的数据
	return matrix.map((val: any, rowIndex: number, colIndex: number) => {
		if (val != undefined) {
...
function generateBody(data: any, schema: any) {
...
function generateRow(data: any, schema: any, dataSize: any, rowStart: any) {
